package com.treeyh.common.zookeeper;
 ...
 * @author TreeYH
 * @version 1.0
 * @description zookeeper监听，任务只启动一个
 * @create 2019-05-17 19:02
 */
public class ZooKeeperDataWatcher implements Watcher{

    private final static Logger logger = LoggerFactory.getLogger(ZooKeeperDataWatcher.class);
